...
(The raw data ("Data for students" folder within the code) is available on the course's moodle page.

The map itself is the file called "map.html". It can be opened in two ways:
1. You can access it here on GitHub → [map.html](https://tobiasgm-tudo.github.io/Data_Visualisation_in_Urban_Ecology_SS26/map.html)
2. You can download the file and open it with a browser of your choice. Internet connection is only needed for displaying the base layer (i.E. the tiles) of the map.
